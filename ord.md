Функция ord в Python используется для получения числового представления (кода) символа в таблице Unicode. Это обратная функция к chr, которая возвращает символ по его числовому значению.
